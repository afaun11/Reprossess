...
public class AdminActivity extends AppCompatActivity {
    ...
    private Button btnKeluar, btnDataBarang;
    ...
    protected void onCreate(Bundle savedInstanceState) {    
        ...
        btnDataBarang.setOnClickListener(v -> startActivity(new Intent(AdminActivity.this, DataBarangActivity.class)));
                        ...
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(AdminActivity.this, "Error membaca pcs", Toast.LENGTH_SHORT).show();
                                }
                            }
